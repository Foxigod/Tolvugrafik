...
function render()
{
    datenow = (Date.now() - lastTime)/1000.0;
    ...
    // Build a seesaw
    // Foot
    mv1 = mult( mv, translate( 0.0, 0.05, 0.0 ) );
    mv1 = mult( mv1, rotateY(datenow*10));
    mv1 = mult( mv1, rotateZ(Math.sin(datenow)*20));
    mv1 = mult( mv1, scalem( 1.4, 0.1, 0.2 ) );
